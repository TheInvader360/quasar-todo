<template>
  <q-layout view="lHh Lpr lFf">
    ...
    >
      ...
      <q-img class="absolute-top" src="../assets/mountains.jpg" style="height: 184px">
        <div class="absolute-bottom bg-transparent">
          <q-avatar size="56px" class="q-mb-sm">
            <img src="https://avatars.githubusercontent.com/u/3944210">
          </q-avatar>
          <div class="text-weight-bold">Darren</div>
          <div>@TheInvader360</div>
        </div>
      </q-img>
    </q-drawer>
